...
// ===== CACHE-ASIDE KEY CONTRACT (ADR 0002) =====
...
{
    // Short TTL (ADR 0002): balances change on transfer. We invalidate the key on a
    ...
    // IDistributedCache: Upstash/Redis in prod, in-memory fallback locally (ADR 0002).
