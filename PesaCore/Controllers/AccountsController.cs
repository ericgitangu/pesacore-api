...
public class AccountsController : ControllerBase
{
    ...
    // In banking at scale (the bank has 19M+ accounts), this would melt the database.
    //
    ...
    // Same result, different cost. Rule of thumb: "It depends on the query profile."
    ...
    // Each tier adds protection. Rule of thumb: "Retry alone is naive — you need
