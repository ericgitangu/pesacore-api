...
// ===== EF Core provider — config-driven (ADR 0002) =====
...
// ===== Distributed cache — config-driven (ADR 0002) =====
...
builder.Services.AddOpenTelemetry()
    ...
    .WithMetrics(metrics =>
    {
        ...
        // OTLP push to the collector — PRIMARY export path (ADR 0001: scale-to-zero
        ...
        // is not in the loop. See ADR 0001.
...
// Prometheus text exposition format. This is the direct-scrape FALLBACK (ADR 0001);
