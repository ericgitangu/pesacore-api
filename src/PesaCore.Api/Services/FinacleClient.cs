namespace PesaCore.Api.Services;

// ===== WHAT IS FINACLE AT EQUITY? =====
// Infosys Finacle is Equity Group's core banking system (CBS), deployed as a single
...
// Equity + Infosys won "Best Core Banking Initiative in Africa" (2020) for this rollout.
// Finacle's centralized architecture enabled Equity to become the first bank in Eastern
